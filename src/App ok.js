    ...
    return (
      <div>
          ...
          <Modal.Body>
            <Form>
              ...
              <Form.Group controlId="ControlTextarea">
                ...
                <Form.Control as="textarea" name="catatan" rows={10} onChange={this.handleChange} value={this.state.dataPost.catatan} />
              </Form.Group>
            </Form>
          </Modal.Body>
          <Modal.Footer>
        ...
        <Navbar bg="dark" variant="dark" sticky="top">
          ...
          <Form inline>
            <FormControl type="text" placeholder="Cari catatan" className="mr-sm-2" onChange={this.handleSearch} />
        ...
        <Container className="text-center">
          ...
          {/* <Button variant="light" size="sm" onClick=""><BsCardList /></Button>
          <Button variant="light" size="sm" onClick=""><BsColumnsGap /></Button> */}
        </Container>
            ...
            return (
              <Card border="light" className="my-2" key={i}>
                <Card.Body className="mx-0 px-0">
                  ...
                  <p><small className="text-muted">dicatat pada: {dt.tanggal}</small></p>
